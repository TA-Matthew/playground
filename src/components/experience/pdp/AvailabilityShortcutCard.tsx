  ...
  return (
    ...
    >
      ...
      <div className="mt-4 flex items-center justify-between gap-3">
        ...
        <button
          type="button"
          className="inline-flex h-9 shrink-0 items-center justify-center rounded-lg border-[1.5px] border-black bg-white px-6 pt-[7px] pb-2 text-sm font-medium leading-5 tracking-[0.05px] text-[#0d0d0d] transition hover:bg-neutral-50 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black"
          onClick={onSelect}
        >
          Select
        </button>
